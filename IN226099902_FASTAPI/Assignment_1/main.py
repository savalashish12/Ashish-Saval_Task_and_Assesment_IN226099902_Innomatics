...
# query 3: Filter products by category (case-insensitive FIXED)
...
# query 4: Show only in-stock products
...
# query 6: Search product by name (case-insensitive already correct)
